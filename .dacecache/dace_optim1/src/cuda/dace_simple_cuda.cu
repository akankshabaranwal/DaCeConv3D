...
int __dace_init_cuda(dace_simple_t *__state) {
    int count;
...
void __dace_runkernel_assign_75_4_map_0_1_4(dace_simple_t *__state, float * __restrict__ gpu_Output)
{
...
void __dace_runkernel_dace_simple_76_d_0_0_19(dace_simple_t *__state, const float * __restrict__ gpu_Input, float * __restrict__ gpu_Output, const float * __restrict__ gpu_kernel)
{
