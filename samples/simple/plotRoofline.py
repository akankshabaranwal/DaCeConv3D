...
plt.title("Roofline Log Log Plot for cudnn on GV100 for different cosmoflow layers Batch size 16")
...
layer3_AI = 108.85
layer3_Perf = 11746
L3 = plt.loglog(layer3_AI, layer3_Perf,'D', label='volta_scudnn_128X128_3dconv_fprop_small_nn_v1')
plt.annotate('3', (layer3_AI, layer3_Perf))

layer4_AI = 191.7
layer4_Perf = 11877
L4 = plt.loglog(layer4_AI, layer4_Perf,'>', label='volta_scudnn_128X128_3dconv_fprop_small_nn_v1')
